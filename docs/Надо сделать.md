...
На странице /checkout/success проверить правильность показа цены доставки, цена 780, а вижу Расчет менеджером. Проблема в том, что если не выбран пункт выдачи, то будет показывать Расчет менеджером.
