 ...
 */
final class Version20250819104252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Очистка мусорных строк перед изменением nullable -> NOT NULL
        $this->addSql('DELETE FROM option_value WHERE option_id IS NULL');
