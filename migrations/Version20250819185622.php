 ...
 */
final class Version20250819185622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_item (id INT AUTO_INCREMENT NOT NULL, cart_id INT NOT NULL, product_id INT NOT NULL, product_name VARCHAR(255) NOT NULL, unit_price INT NOT NULL, qty INT NOT NULL, row_total INT NOT NULL, version INT DEFAULT 1 NOT NULL, INDEX IDX_F0FE25271AD5CDBF (cart_id), INDEX IDX_F0FE25274584665A (product_id), UNIQUE INDEX uniq_cart_product (cart_id, product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_attribute (id INT AUTO_INCREMENT NOT NULL, product_attribute_group_id INT DEFAULT NULL, attribute_id INT NOT NULL, product_id INT DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, INDEX IDX_94DA59769000C6CB (product_attribute_group_id), INDEX IDX_94DA5976B6E62EFA (attribute_id), INDEX IDX_94DA59764584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product_attribute ADD CONSTRAINT FK_94DA5976B6E62EFA FOREIGN KEY (attribute_id) REFERENCES attribute (id) ON DELETE RESTRICT');
