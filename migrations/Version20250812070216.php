 ...
 */
final class Version20250812070216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attribute (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attribute_group (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE carousel (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, products_id JSON DEFAULT NULL, sort INT DEFAULT NULL, place VARCHAR(255) DEFAULT NULL, INDEX IDX_1DD747004584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, price INT DEFAULT NULL, sale_price INT DEFAULT NULL, sort_order INT DEFAULT NULL, meta_title VARCHAR(255) DEFAULT NULL, meta_description VARCHAR(255) DEFAULT NULL, meta_keywords VARCHAR(255) DEFAULT NULL, manufacturer INT DEFAULT NULL, status TINYINT(1) DEFAULT 0 NOT NULL, quantity INT DEFAULT NULL, meta_h1 VARCHAR(255) DEFAULT NULL, date_added DATETIME DEFAULT NULL, date_edited DATETIME DEFAULT NULL, options_json JSON DEFAULT NULL, attribute_json JSON DEFAULT NULL, code BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', description VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_D34A04AD77153098 (code), INDEX name (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_image (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, image_url VARCHAR(255) NOT NULL, sort_order INT NOT NULL, INDEX product_id (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
