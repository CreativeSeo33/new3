 ...
 */
final class Version20250903181051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attribute (id INT AUTO_INCREMENT NOT NULL, attribute_group_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, sort_order INT DEFAULT NULL, show_in_category TINYINT(1) DEFAULT NULL, short_name VARCHAR(255) DEFAULT NULL, code VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_FA7AEFFB77153098 (code), INDEX IDX_FA7AEFFB62D643B7 (attribute_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attribute_group (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, sort_order INT DEFAULT NULL, code VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_8EF8A77377153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, token VARCHAR(36) DEFAULT NULL, currency VARCHAR(3) NOT NULL, subtotal INT DEFAULT 0 NOT NULL, discount_total INT DEFAULT 0 NOT NULL, total INT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', version INT DEFAULT 1 NOT NULL, shipping_method VARCHAR(64) DEFAULT NULL, shipping_cost INT DEFAULT 0 NOT NULL, ship_to_city VARCHAR(128) DEFAULT NULL, shipping_data JSON DEFAULT NULL, UNIQUE INDEX UNIQ_BA388B75F37A13B (token), INDEX IDX_BA388B75F37A13B (token), INDEX IDX_BA388B7A76ED395 (user_id), INDEX IDX_BA388B7F9D83E2 (expires_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cart_item (id INT AUTO_INCREMENT NOT NULL, cart_id INT NOT NULL, product_id INT NOT NULL, product_name VARCHAR(255) NOT NULL, unit_price INT NOT NULL, qty INT NOT NULL, row_total INT NOT NULL, options_price_modifier INT DEFAULT 0 NOT NULL, effective_unit_price INT DEFAULT 0 NOT NULL, options_hash VARCHAR(32) DEFAULT NULL, selected_options_data JSON DEFAULT NULL, options_snapshot JSON DEFAULT NULL, version INT DEFAULT 1 NOT NULL, INDEX IDX_F0FE25271AD5CDBF (cart_id), INDEX IDX_F0FE25274584665A (product_id), UNIQUE INDEX uniq_cart_product_options (cart_id, product_id, options_hash), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, address VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(255) DEFAULT NULL, federal_district VARCHAR(255) DEFAULT NULL, region_type VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, city_type VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, kladr_id BIGINT DEFAULT NULL, fias_level INT DEFAULT NULL, capital_marker INT DEFAULT NULL, geo_lat DOUBLE PRECISION DEFAULT NULL, geo_lon DOUBLE PRECISION DEFAULT NULL, population BIGINT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE city_modal (id INT AUTO_INCREMENT NOT NULL, fias_id BIGINT DEFAULT NULL, name VARCHAR(255) NOT NULL, sort INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE delivery_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, active TINYINT(1) NOT NULL, sort_order INT NOT NULL, is_default TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5D429FB377153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `option` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, sort_order INT NOT NULL, code VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_5A8600B077153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE option_value (id INT AUTO_INCREMENT NOT NULL, option_id INT NOT NULL, value VARCHAR(255) NOT NULL, sort_order INT NOT NULL, code VARCHAR(100) DEFAULT NULL, INDEX IDX_249CE55CA7C41D6F (option_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product_to_category (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, category_id INT NOT NULL, is_parent TINYINT(1) DEFAULT 0, position INT DEFAULT 1, visibility TINYINT(1) DEFAULT 1, INDEX IDX_673A19704584665A (product_id), INDEX IDX_673A197012469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pvz_points (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, city_code VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, tariff_zone VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, delivery_period INT DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, type_of_office VARCHAR(20) DEFAULT NULL, metro VARCHAR(255) DEFAULT NULL, only_prepaid_orders VARCHAR(5) DEFAULT NULL, postal INT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, time VARCHAR(255) DEFAULT NULL, card INT DEFAULT NULL, shirota DOUBLE PRECISION DEFAULT NULL, dolgota DOUBLE PRECISION DEFAULT NULL, company VARCHAR(20) DEFAULT NULL, INDEX city (city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pvz_price (id INT AUTO_INCREMENT NOT NULL, city VARCHAR(255) NOT NULL, srok VARCHAR(255) DEFAULT NULL, city2 VARCHAR(255) DEFAULT NULL, code VARCHAR(20) DEFAULT NULL, alias VARCHAR(255) DEFAULT NULL, region VARCHAR(255) DEFAULT NULL, cost INT DEFAULT NULL, free INT DEFAULT NULL, calculate_price INT DEFAULT NULL, calculate_delivery_period VARCHAR(255) DEFAULT NULL, INDEX city (city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE product_to_category ADD CONSTRAINT FK_673A19704584665A FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE product_to_category ADD CONSTRAINT FK_673A197012469DE2 FOREIGN KEY (category_id) REFERENCES category (id) ON DELETE CASCADE');
    }
